...
class HybridAgent(ToolAgent):
    ...
    def add_specialized_agent(self, role: str, config: Dict[str, Any]) -> None:
        ...
        logging.info(f"Added specialized agent with role '{role}' to HybridAgent '{self.name}'")
